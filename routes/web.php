...
use App\Http\Controllers\Admin\Market\VideoController;
...
use App\Http\Controllers\Customer\FilmController;
...
Route::prefix('admin')->middleware('auth')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('product')->group(function () {
            ...
            //video
            Route::get('/video/{product}', [VideoController::class, 'index'])->name('admin.market.video.index');
            Route::get('/video/create/{product}', [VideoController::class, 'create'])->name('admin.market.video.create');
            Route::post('/video/store/{product}', [VideoController::class, 'store'])->name('admin.market.video.store');
            Route::get('/edit/{video}/{product}', [VideoController::class, 'edit'])->name('admin.market.video.edit');
            Route::put('/update/{video}/{product}', [VideoController::class, 'update'])->name('admin.market.video.update');
            Route::delete('/video/destroy/{product}/{video}', [VideoController::class, 'destroy'])->name('admin.market.video.destroy');
...
Route::namespace('Auth')->group(function () {
    ...
    Route::post('/login-confirm/{token}/{otpCode}', [LoginRegisterController::class, 'loginConfirm'])->name('auth.customer.login-confirm');
...
Route::post('/cart/add/{film}', [CartController::class, 'add'])->name('cart.add');
Route::delete('/cart/remove/{film}', [CartController::class, 'remove'])->name('cart.remove');

// سفارش‌ها و پرداخت
Route::get('/orders/create', [CustomerOrderController::class, 'create'])->name('orders.create');
Route::get('/orders', [CustomerOrderController::class, 'create'])->name('orders.index');

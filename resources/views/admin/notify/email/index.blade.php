                    ...
                    <table class="table table-striped table-hover">
                        ...
                        @foreach ($emails as $key => $email)
                            ...
                            <tr>
                                ...
                                <td>{{ $email->subject }}</td>
                                <td>{{ $email->body }}</td>
                                <td>{{  \Morilog\Jalali\Jalalian::forge($email->published_at)->format('%A, %d %B %Y H:i:s') }}</td>
                                ...
                                <td class="width-16-rem text-left">
                                    <a href="{{ route('admin.notify.email-file.index', $email->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-file"></i> فایل های ضمیمه شده</a>                                    <a href="{{ route('admin.notify.email.edit', $email->id) }}" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> ویرایش</a>

...
@section('content')
    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item font-size-12 active" aria-current="page"> فیلم ها</li>
        </ol>
    </nav>
        ...
        <section class="col-12">
            <section class="main-body-container">
                ...
                <section class="d-flex justify-content-between align-items-center mt-4 mb-3 border-bottom pb-2">
                    <a href="{{ route('admin.market.product.create') }}" class="btn btn-info btn-sm">ایجاد فیلم
                        جدید </a>
                    ...
                    <table class="table table-striped table-hover h-150px">
                        ...
                        @foreach ($products as $product)
                            ...
                            <tr>
                                ...
                                <td>{{ $product->name }}</td>
                                <td>{{ storage_path($product->main) }}</td>
                                <td><img src="{{ asset($product->image ) }}" alt="" width="100" height="50"></td>
                                ...
                                <td class="width-8-rem text-left">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                            ...
                                            <a href="{{ route('admin.market.video.index', $product->id) }}"
                                               class="dropdown-item text-right"><i class="fa fa-images"></i> ویدیو</a>

...
class ProductController extends Controller
{
    public function product(Product $product)
    {
        ...
        $relateIds=explode(',',$product->relatedProducts);
        $relatedProducts=Product::whereIn('id',$relateIds)->get();
 ...
 /*       if ($product->relatedProducts){
     ...
     /*   $xx=explode(',',$product->relatedProducts);
        ...
        if (!$product->relatedProducts) {
            ...
            foreach ($relatedProducts as $relatedProduct) {
                $p = Product::where('id', $relatedProduct->id)->first();
     ...
     //   dd(explode(',',$product->relatedProducts));
        $s=Product::where('relatedProducts',explode(',',$product->relatedProducts))->get();
